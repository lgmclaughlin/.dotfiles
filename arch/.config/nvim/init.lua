...
vim.api.nvim_set_keymap('n', '<leader>cn', ':lua require("comments").insert_new_section()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>cs', ':lua require("comments").insert_summary()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>r', ':lua require("devtools").reload_config()<CR>', { noremap = true, silent = true })

vim.keymap.set('n', '<leader>rp', '"_diwP', { noremap = true, silent = true, desc = "Replace word with paste" })
vim.keymap.set('n', '<leader>srp', '"_dgnP<Esc>n', { noremap = true, silent = true, desc = "Replace search match and move next" })
    ...
    },
    {
      ...
      config = function()
        require('strudel').setup {
          ...
          --custom_css_file = '~/.config/strudel-nvim/custom.css',
          ...
          -- (optional, default: nil)
          browser_exec_path = '/bin/google-chrome-stable',
        }
      end,
    },
    config = function()
